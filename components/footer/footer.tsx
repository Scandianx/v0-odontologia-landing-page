      ...
      <div className={styles.container}>
        <div className={styles.content}>
          <div className={styles.brand}>
            ...
            <p>Odontologia humanizada com foco em conforto, estética natural e resultados que transformam sorrisos.</p>
          </div>
        ...
        <div className={styles.bottom}>
          <p className={styles.copyright}>
            © {new Date().getFullYear()} Dra. Jalimar Martins. Todos os direitos reservados.
          </p>
          <div className={styles.social}>
            <a
              href="https://instagram.com/dra.jalimarmartins"
              target="_blank"
