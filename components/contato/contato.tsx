      ...
      <div className={styles.container}>
        ...
        <div className={styles.content}>
          <div className={styles.cardsGrid}>
            <div className={`${styles.card} zoom-in anim-delay-1`}>
            ...
            <div className={`${styles.card} zoom-in anim-delay-2`}>
              <div className={styles.cardIcon}>
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
            ...
            <div className={`${styles.card} zoom-in anim-delay-3`}>
              <div className={styles.cardIcon}>
            ...
            <div className={`${styles.card} zoom-in anim-delay-4`}>
              <div className={styles.cardIcon}>
                <svg fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path
                    strokeLinecap="round"
          ...
          <div className={`${styles.mapWrapper} blur-in`}>
            <iframe
              src="https://www.google.com/maps?q=-21.65332800706428,-41.74989187626808&hl=pt-BR&z=17&output=embed"
              allowFullScreen
              loading="lazy"
